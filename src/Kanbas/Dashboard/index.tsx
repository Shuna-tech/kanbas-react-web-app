                    ...
                    <div className="wd-dashboard-course col" style={{width: "260px", marginBottom: "35px"}}>
                        <div className="card" style={{height: "300px"}}>
                            ...
                            <div className="card-body d-flex flex-column">
                                ...
                                <p className="wd-dashboard-course-programming-design flex-grow-1"
                                    style={{whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis"}}>
                                    Introduction to programming design
                                </p>
                                <a href="#Kanbas/Courses/5010/Home" className="btn btn-primary mt-auto align-self-start">Go</a>
                            </div>
                        </div>
                    </div>
                    <div className="wd-dashboard-course col" style={{width: "260px", marginBottom: "35px"}}>
                        <div className="card" style={{height: "300px"}}>
                            ...
                            <div className="card-body d-flex flex-column">
                                ...
                                <a href="#Kanbas/Courses/5610/Home" className="btn btn-primary mt-auto align-self-start">Go</a>
                            </div>
                        </div>
                    ...
                    <div className="wd-dashboard-course col" style={{width: "260px", marginBottom: "35px"}}>
                        <div className="card" style={{height: "300px"}}>
                            ...
                            <div className="card-body d-flex flex-column">
                                ...
                                <a href="#Kanbas/Courses/5800/Home" className="btn btn-primary mt-auto align-self-start">Go</a>
                            </div>
                        </div>
                    </div>
                    <div className="wd-dashboard-course col" style={{width: "260px", marginBottom: "35px"}}>
                        <div className="card" style={{height: "300px"}}>
                            ...
                            <div className="card-body d-flex flex-column">
                                ...
                                <a href="#Kanbas/Courses/5400/Home" className="btn btn-primary mt-auto align-self-start">Go</a>
                            </div>
                        </div>
                    </div>
                    <div className="wd-dashboard-course col" style={{width: "260px", marginBottom: "35px"}}>
                        <div className="card" style={{height: "300px"}}>
                            ...
                            <div className="card-body d-flex flex-column">
                                ...
                                <a href="#Kanbas/Courses/5600/Home" className="btn btn-primary mt-auto align-self-start">Go</a>
                            </div>
                        </div>
                    </div>
                    <div className="wd-dashboard-course" style={{width: "260px", marginBottom: "35px"}}>
                        <div className="card" style={{height: "300px"}}>
                            ...
                            <div className="card-body d-flex flex-column">
                                ...
                                <a href="#Kanbas/Courses/6410/Home" className="btn btn-primary mt-auto align-self-start">Go</a>
                            </div>
                        </div>
                    </div>
                    <div className="wd-dashboard-course" style={{width: "260px", marginBottom: "35px"}}>
